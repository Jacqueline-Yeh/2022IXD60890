...
<form method="post" action="{$_SERVER['PHP_SELF']}?id=$id&action=$createorupdate">
	...
	<div class="form-control">
		...
		<input class="form-input" name="user-name" id="user-name" type="text" placeholder="
			Enter User Name" value="$user->name">
	</div>
	<div class="form-control">
		<label class="form-label" for="user-type">Type</label>
		<input class="form-input" name="user-type" id="user-type" type="text" placeholder="
			Enter User Type" value="$user->type">
	</div>
	<div class="form-control">
		<label class="form-label" for="user-email">Email</label>
		<input class="form-input" name="user-email" id="user-email" type="text" placeholder="
			Enter User Email" value="$user->email">
	</div>
	<div class="form-control">
